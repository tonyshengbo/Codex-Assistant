 ...
 */
internal fun timelineMessageViewportHeightPx(
    fullContentHeightPx: Int,
    collapsedMaxHeightPx: Int,
    expanded: Boolean,
): Int {
    ...
    if (!timelineShouldCollapseMessageContent(fullContentHeightPx, collapsedMaxHeightPx)) {
...
internal fun TimelineCollapsibleMessageContent(
    ...
    val targetViewportHeightPx = timelineMessageViewportHeightPx(
        fullContentHeightPx = measuredContentHeightPx,
        collapsedMaxHeightPx = collapsedMaxHeightPx,
        expanded = expanded,
    )

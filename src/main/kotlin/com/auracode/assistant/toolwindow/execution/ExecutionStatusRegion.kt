...
@Composable
internal fun ExecutionTurnStatusRegion(
    p: DesignPalette,
    state: ExecutionStatusAreaState,
) {
    val turnStatus = state.turnStatus ?: return
    val t = assistantUiTokens()
    val appearance = executionTurnStatusAppearanceSpec()
    ...
    Row(
        ...
        Box(
            ...
            Text(
                text = AssistantUiText.formatDuration(nowMs - turnStatus.startedAtMs),
...
@Composable
internal fun ExecutionStatusToastOverlay(
    p: DesignPalette,
    state: ExecutionStatusAreaState,

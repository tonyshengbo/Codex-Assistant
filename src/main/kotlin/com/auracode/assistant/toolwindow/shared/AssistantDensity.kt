...
private fun assistantUiTokens(scale: Float): AssistantUiTokens {
    ...
    return AssistantUiTokens(
        spacing = AssistantSpacing(
            xs = scaledDp(4.4f, min = 3f),
            sm = scaledDp(8.8f, min = 6f),
            md = scaledDp(13.2f, min = 9f),
            lg = scaledDp(17.6f, min = 12f),
            xl = scaledDp(22f, min = 16f),
        ),
        type = AssistantTypeScale(
            meta = scaledText(12.1f),
            body = scaledText(15.4f),
            label = scaledText(13.2f),
            sectionTitle = scaledText(15.4f),
            title = scaledText(16.5f),
        ),
        controls = AssistantControlScale(
            iconSm = scaledIcon(13.2f),
            iconMd = scaledIcon(15.4f),
            iconLg = scaledIcon(19.8f),
            headerActionTouch = scaledControl(26.4f, min = 22f),
            sendButton = scaledControl(41.8f, min = 34f),
            railItem = scaledControl(44f, min = 36f),
            attachmentCard = scaledControl(48.4f, min = 38f),
        ),
        markdown = AssistantMarkdownScale(
            codePadding = scaledDp(8.8f, min = 6f),
            codeCorner = 8.8.dp,
            quoteIndent = scaledDp(8.8f, min = 6f),
            quoteThickness = scaledDp(3.3f, min = 2f),
            blockSpacing = scaledDp(6.6f, min = 4f),
            listSpacing = scaledDp(4.4f, min = 3f),
            listItemTop = scaledDp(3.3f, min = 2f),
            listItemBottom = scaledDp(4.4f, min = 3f),
            listIndent = scaledDp(13.2f, min = 9f),
            tableCellPadding = scaledDp(8.8f, min = 6f),
        ),
    )
}

...
@Composable
internal fun SubmissionApprovalSection(
    p: DesignPalette,
 ...
 */
private fun approvalBadgeLabel(kind: ProviderApprovalRequestKind): String {
    return when (kind) {
        ProviderApprovalRequestKind.COMMAND -> AuraCodeBundle.message("composer.approval.badge.command")
        ProviderApprovalRequestKind.FILE_CHANGE -> AuraCodeBundle.message("composer.approval.badge.fileChange")
        ProviderApprovalRequestKind.PERMISSIONS -> AuraCodeBundle.message("composer.approval.badge.permissions")
    }
}

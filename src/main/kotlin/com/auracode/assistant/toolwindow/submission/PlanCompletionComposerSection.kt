...
): ComposerInteractionFocusTarget {
    return restoreComposerInteractionFocusTarget(preferInput = selectedAction == PlanCompletionAction.REVISION)
}

@Composable
internal fun PlanCompletionComposerSection(
    p: DesignPalette,
    state: ComposerPlanCompletionState,
    ...
    LaunchedEffect(state.turnId, state.selectedAction) {
        withFrameNanos { }
        restoreComposerInteractionFocus(

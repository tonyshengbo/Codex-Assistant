 ...
 */
internal data class TimelineContextMenuAppearance(
 ...
 */
internal fun timelineContextMenuAppearance(
    palette: DesignPalette,
): TimelineContextMenuAppearance {
    return TimelineContextMenuAppearance(
...
@Composable
internal fun rememberTimelineContextMenuRepresentation(
    palette: DesignPalette,
): ContextMenuRepresentation {
    val tokens = assistantUiTokens()
    val appearance = remember(palette) { timelineContextMenuAppearance(palette) }
    val shape = remember(tokens.spacing.sm) { RoundedCornerShape(tokens.spacing.sm) }
    return remember(appearance, shape) {
        TimelineContextMenuRepresentation(
 ...
 */
@OptIn(ExperimentalFoundationApi::class)
private class TimelineContextMenuRepresentation(
    private val appearance: TimelineContextMenuAppearance,
 ...
 */
@Composable
private fun TimelineContextMenuItem(
    item: ContextMenuItem,
    appearance: TimelineContextMenuAppearance,
    onClick: () -> Unit,
) {
    val tokens = assistantUiTokens()

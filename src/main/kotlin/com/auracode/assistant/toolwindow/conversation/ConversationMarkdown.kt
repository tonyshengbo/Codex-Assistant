...
internal fun ConversationMarkdown(
    ...
    val bodyLineHeight = conversationMarkdownBodyLineHeightSp(tokens.type.body.value)
    val selectionColors = rememberConversationMarkdownSelectionColors(palette)
    val externalUriHandler = LocalUriHandler.current
    val uriHandler = rememberConversationMarkdownUriHandler(
...
internal fun conversationMarkdownBodyLineHeightSp(bodyFontSizeSp: Float): Float {
    return bodyFontSizeSp * 1.5f
}

@Composable
private fun rememberConversationMarkdownUriHandler(
...
internal fun resolveConversationMarkdownFilePath(target: String): String? {

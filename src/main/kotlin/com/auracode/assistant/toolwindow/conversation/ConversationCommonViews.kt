...
@Composable
internal fun ConversationExpandableCard(
    title: String,
    ...
    expandedBodyMaxHeight: Dp? = conversationExpandedBodyMaxHeight(),
            ...
            Box(
                ...
                Column {
                    Row(
                        ...
                        ConversationExpandableCardTitle(
                            title = title,
                    ...
                    if (expanded) {
                        ...
                        ConversationExpandableCardBody(
                            palette = palette,
                        ...
                        ConversationSelectableText(
                            selectionColors = rememberConversationMarkdownSelectionColors(palette),
                        ) {
                            Text(
...
@Composable
internal fun ConversationMarkdownActivityBody(
    title: String,
    titleIconPath: String? = null,
    headerBadge: String? = null,
    titleTargetLabel: String? = null,
...
@Composable
private fun ConversationExpandableCardBody(
    palette: DesignPalette,
...
@Composable
private fun ConversationExpandableCardTitle(
    title: String,
...
internal fun conversationExpandedBodyMaxHeight(): Dp = 220.dp

internal fun timelineCommandExpandedBodyMaxHeight(): Dp = 240.dp

internal fun conversationPlanExpandedBodyMaxHeight(): Dp? = null

 ...
 */
internal data class ConversationMessageCollapseControlModel(
 ...
 */
internal fun conversationMessageCollapseControlModel(expanded: Boolean): ConversationMessageCollapseControlModel {
    return if (expanded) {
        ConversationMessageCollapseControlModel(
 ...
 */
@Composable
internal fun ConversationMessageCollapseControl(
    expanded: Boolean,
    palette: DesignPalette,
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
) {
    val model = conversationMessageCollapseControlModel(expanded = expanded)
...
internal fun TimelineCollapsedMessageOverlay(
    ...
    Box(
        ...
        ConversationMessageCollapseControl(
            expanded = false,
            palette = palette,
            modifier = Modifier

...
internal class CodexProviderItemLifecycleParser(
    private val typeParsers: CodexProviderItemTypeParsers,
) {
    private val typeRouter = CodexProviderItemTypeRouter(typeParsers)
     ...
     */
    fun parseItemStarted(params: JsonObject, state: CodexProtocolParserState): ProviderEvent? {
     ...
     */
    fun parseItemCompleted(params: JsonObject, state: CodexProtocolParserState): ProviderEvent? {
    ...
    private fun parseItemLifecycle(
        ...
        val canonicalType = CodexProviderItemTypeAliases.canonicalType(item.string("type")) ?: return null
        ...
        return ProviderEvent.ItemUpdated(parsed)
    }

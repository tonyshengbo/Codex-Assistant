...
internal class CodexUnifiedItemTypeParsers {
    /**
     ...
     */
    fun parseAgentMessage(item: JsonObject, status: ItemStatus): UnifiedItem {
        return UnifiedItem(
     ...
     */
    fun parseReasoning(item: JsonObject, status: ItemStatus): UnifiedItem {
        return UnifiedItem(
    ...
    fun parseFileChange(
        item: JsonObject,
        status: ItemStatus,
        previousChanges: List<UnifiedFileChange>,
    ): UnifiedItem {
     ...
     */
    fun parseContextCompaction(item: JsonObject, status: ItemStatus): UnifiedItem {
        return UnifiedItem(
     ...
     */
    fun parseWebSearch(item: JsonObject, status: ItemStatus): UnifiedItem {
        return UnifiedItem(
     ...
     */
    fun parseMcpToolCall(item: JsonObject, status: ItemStatus): UnifiedItem {
     ...
     */
    fun parsePlan(item: JsonObject, status: ItemStatus): UnifiedItem {
        return UnifiedItem(
     ...
     */
    fun parseUserMessage(item: JsonObject, status: ItemStatus): UnifiedItem {
        return UnifiedItem(
     ...
     */
    fun parseFallback(item: JsonObject, normalizedType: String, status: ItemStatus): UnifiedItem {
    ...
    private fun extractFileChangeSummary(changes: List<UnifiedFileChange>, item: JsonObject): String {
    ...
    private fun extractFileChanges(item: JsonObject, sourceId: String): List<UnifiedFileChange> {

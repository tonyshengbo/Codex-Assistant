...
internal class CodexUnifiedDeltaEventParser {
    /**
     ...
     */
    fun parseAgentMessageDelta(params: JsonObject, state: CodexUnifiedParserState): UnifiedEvent? {
     ...
     */
    fun parseReasoningDelta(params: JsonObject, state: CodexUnifiedParserState): UnifiedEvent? {
     ...
     */
    fun parseCommandExecutionOutputDelta(params: JsonObject, state: CodexUnifiedParserState): UnifiedEvent? {
     ...
     */
    fun parseFileChangeOutputDelta(params: JsonObject, state: CodexUnifiedParserState): UnifiedEvent? {
     ...
     */
    fun parsePlanDelta(params: JsonObject, state: CodexUnifiedParserState): UnifiedEvent? {

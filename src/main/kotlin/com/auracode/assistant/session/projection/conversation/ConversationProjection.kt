...
import com.auracode.assistant.toolwindow.conversation.TimelineMessageAttachment
import com.auracode.assistant.toolwindow.conversation.TimelineNode
import com.auracode.assistant.toolwindow.conversation.TimelineAttachmentKind
 ...
 */
internal class ConversationProjectionBuilder {
    /** Projects one immutable session state snapshot into timeline-ready nodes. */
    fun project(state: SessionState): ConversationProjection {
    ...
    private fun buildNodes(state: SessionState): List<TimelineNode> {
        return buildList {
    ...
    private fun SessionConversationEntry.Message.toNode(state: SessionState): TimelineNode.MessageNode {
    ...
    private fun SessionConversationEntry.Reasoning.toNode(): TimelineNode.ReasoningNode {
        return TimelineNode.ReasoningNode(
    ...
    private fun SessionConversationEntry.Command.toNode(): TimelineNode.CommandNode {
        ...
        return TimelineNode.CommandNode(
    ...
    private fun SessionConversationEntry.Tool.toNode(): TimelineNode.ToolCallNode {
        ...
        return TimelineNode.ToolCallNode(
    ...
    private fun SessionConversationEntry.FileChanges.toNodes(): List<TimelineNode.FileChangeNode> {
    ...
    private fun SessionConversationEntry.Approval.toNode(): TimelineNode.ApprovalNode {
        return TimelineNode.ApprovalNode(
    ...
    private fun SessionConversationEntry.ToolUserInput.toNode(): TimelineNode.UserInputNode {
        val body = when {
        ...
        return TimelineNode.UserInputNode(
    ...
    private fun SessionConversationEntry.Error.toNode(): TimelineNode.ErrorNode {
        return TimelineNode.ErrorNode(
